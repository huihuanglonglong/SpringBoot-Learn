...
public class GenericUtils {
    ...
    private static List<Type> getGenericTypes(Class clazz) {
        ...
        List<Type> typeList = Lists.newArrayList(clazz.getGenericInterfaces());
        typeList.add(clazz.getGenericSuperclass());
        return typeList;
    }
    ...
    private static Map<String, Type> combine(Type[] typeArguments, Class rawClass) {
        Map<String, Type> map = new HashMap<>(typeArguments.length);
